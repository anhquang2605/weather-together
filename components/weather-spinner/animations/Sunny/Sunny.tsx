        ...
        <div className={style['sunny']}>
            <svg width="60mm" height="60mm" version="1.1" viewBox="0 0 60 60"  xmlns="http://www.w3.org/2000/svg">
                <g stroke-linecap="round" stroke-width="1.3229">
                    ...
                    <circle id={style["sunny-sun_stroke"]} cx="30" cy="30" r="12.111" fill="none" stroke="#000" />
                    <circle id={style["sunny-filled_sun"]} cx="30" cy="29.981" r="12.111" fill="#fff57e" stroke="#ffc60b" />
                </g>
            </svg>
        </div>
    );
