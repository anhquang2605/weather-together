...
const Windy: React.FC<WindyProps> = ({}) => {
    ...
    return (
        <div className={style['windy']}>
            ...
            <path id={style['wind_path_3']} transform="scale(.26458)" d="m105.63 110.32c-6e-3 7e-3 -0.0193-0.0169-0.0198-0.0181-0.0439-0.10691 0.12834-0.17533 0.20141-0.18077 0.45013-0.0335 0.62936 0.55056 0.58547 0.89963-0.14908 1.1857-1.614 1.5518-2.5937 1.2986-2.4801-0.64095-3.1302-3.7051-2.377-5.8396 1.5937-4.5162 7.254-5.5668 11.251-3.874 7.4904 3.1724 9.0768 12.726 5.8418 19.489-5.5538 11.61-20.618 13.887-31.257 8.3315-17.093-8.925-20.233-31.454-11.394-47.296 13.483-24.165 45.783-28.362 68.38-15.081 33.061 19.431 38.529 64.175 19.444 95.313-26.983 44.024-87.223 50.995-128.93 24.533" stroke="#00eab5" stroke-linejoin="round" stroke-width="1.9994"/>
            </g>
