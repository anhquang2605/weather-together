   ...
   /*                  {
    ...
    return (
        <div className={style['windy']}>
            ...
            <g className={style['leaves']} id="leave_1">
                <path d="m23.68 29.382s2.6693 1.3323 3.9319 1.2388c2.8542-0.2114 4.287-1.6411 4.287-1.6411-0.95727-0.57706-1.6822-1.3843-3.0481-1.3752-1.3796 0.0092-2.2172 0.86062-3.4437 1.383-0.56187 0.2393-1.7271 0.39444-1.7271 0.39444z" fill="#9afd3a" stroke-width=".61097"/>
                <path d="m31.899 28.98s-3.1221 0.6606-5.4505 0.48546c-2.3735-0.17845-2.9283-0.32889-3.268-0.3576-0.40712-0.03439-0.46413 0.37987-0.09225 0.39985 0.91244 0.04902 1.7931 0.05666 3.4836 0.09591 2.5391 0.05897 5.3271-0.62371 5.3271-0.62371z" fill="#9a563a" stroke-width="1.7602"/>
            </g>
            <g className={style['leaves']} id="leave_2">
                <path d="m27.771 30.382c1.9702 0 4.1284-1.4011 4.1284-1.4011-1.1199-0.67509-2.6613-1.4388-4.0043-1.4674-3.6867-0.07865-5.0757 2.767-0.12418 2.8686h9e-6z" fill="#9afd3a" stroke-width=".71475"/>
                <path d="m31.899 28.98s-3.105 0.2976-5.4334 0.12246c-2.3735-0.17845-2.9117-0.29292-3.2514-0.32162-0.40712-0.03439-0.46413 0.37987-0.09225 0.39985 0.91244 0.04902 1.7204 0.04839 3.4109 0.08764 2.5391 0.05897 5.3662-0.28841 5.3662-0.28841z" fill="#9a563a" stroke-width="1.7602"/>
            </g>
            <g className={style['leaves']} id="leave_3">
                <path d="m31.149 30.527s-2.0235 0.4425-3.2624 0.35679c-2.8001-0.19373-4.206-1.5038-4.206-1.5038 0.93917-0.5288 2.7596-1.4486 4.2009-1.2046 1.3529 0.22907 2.2728 0.92506 3.2673 2.3516z" fill="#9afd3a" stroke-width=".71311"/>
                <path d="m23.68 29.382s1.2487 0.04714 3.5771 0.22226c2.3735 0.17845 4.4535 1.499 4.7932 1.5277 0.40712 0.03439 0.36031-0.41205 0.01285-0.54589-0.94995-0.36584-3.0397-1.1254-4.7302-1.1647-2.5391-0.05897-3.653-0.03946-3.653-0.03946z" fill="#9a563a" stroke-width="1.7602"/>
            </g>
