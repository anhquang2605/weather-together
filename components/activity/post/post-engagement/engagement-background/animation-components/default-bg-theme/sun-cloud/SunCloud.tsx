    ...
    return (
        <div className={style['sun-cloud']}>
            <svg width="47.47mm" height="34.219mm" version="1.1" viewBox="0 0 47.47 34.219" xmlns="http://www.w3.org/2000/svg">
                ...
                <path id="glasses-spark" d="m82.642 42.189-1.193-1.5176-1.911 0.19351 1.5176-1.193-0.19351-1.911 1.193 1.5176 1.911-0.19351-1.5176 1.193z" fill="#f2ff12" stroke="#f2ff12" stroke-linecap="round" stroke-linejoin="round" stroke-width=".58692"/>
                </g>
            </svg>
        </div>
    );
