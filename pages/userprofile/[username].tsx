...
export default function UserProfile({userJSON}:UserProfileProps){
  ...
  useEffect(() => {
    window.addEventListener('resize', handleSettingDimensionWhenResize);
    handleSettingDimensionWhenResize();
    return () => {
      window.removeEventListener('resize', handleSettingDimensionWhenResize);
    }
  }, []);
    return (
        <>
